...
return [
    ...
    'act_report'            => 'Шаблон акта',
    'make_act_report'       => 'Получить АКТ',
    ...
    'act_fields_info'    => '<p>Выберите пользователя для которого хотите получить акт приема передачи, затем выберите устройства которые вы хотите включить в акт, и нажмите "Сгенерировать". Файл (act-asset-report-YYYY-mm-dd.csv) загрузится автоматически.</p>',        
    'range'                 => 'Диапазон',
