...
class AssetMaintenancesController extends Controller
{
    ...
    */
    public function store(Request $request) : RedirectResponse
    {
        ...
        if ($request->input('asset_maintenance_type') == trans('admin/asset_maintenances/general.technical_inspection')) {
            $assetMaintenance->is_technical_inspection = 1;
        } else {
            $assetMaintenance->is_technical_inspection = 0;
        }
